...
| <a name="input_admissioncontroller_tolerations"></a> [admissioncontroller\_tolerations](#input\_admissioncontroller\_tolerations) | Tolerations for admissioncontroller pods. | <pre>list(object({<br/>    key      = string<br/>    operator = string<br/>    value    = string<br/>    effect   = string<br/>  }))</pre> | `[]` | no |
...
| <a name="input_backgroundcontroller_tolerations"></a> [backgroundcontroller\_tolerations](#input\_backgroundcontroller\_tolerations) | Tolerations for backgroundcontroller pods. | <pre>list(object({<br/>    key      = string<br/>    operator = string<br/>    value    = string<br/>    effect   = string<br/>  }))</pre> | `[]` | no |
...
| <a name="input_cleanupcontroller_tolerations"></a> [cleanupcontroller\_tolerations](#input\_cleanupcontroller\_tolerations) | Tolerations for cleanupcontroller pods. | <pre>list(object({<br/>    key      = string<br/>    operator = string<br/>    value    = string<br/>    effect   = string<br/>  }))</pre> | `[]` | no |
...
| <a name="input_reportscontroller_tolerations"></a> [reportscontroller\_tolerations](#input\_reportscontroller\_tolerations) | Tolerations for reportscontroller pods. | <pre>list(object({<br/>    key      = string<br/>    operator = string<br/>    value    = string<br/>    effect   = string<br/>  }))</pre> | `[]` | no |
